          ...
          <div className="lg:pl-12 flex-1">
            <div className="space-y-6 progressive-reveal">
              <div className="space-y-4">
                <div className="inline-flex items-center space-x-2 bg-namespace-white/80 border border-namespace-purple/20 px-4 sm:px-6 py-2 sm:py-3 rounded-full">
                  <div className="w-2 h-2 bg-namespace-purple rounded-full animate-pulse" />
                  <span className="text-xs sm:text-sm font-medium text-namespace-purple transition-all duration-500">
                    {taglines[currentTaglineIndex]}
                  </span>
                </div>

                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-sora font-bold leading-tight">
                  Welcome to
                  <br />
                  <span className="text-namespace-purple inline-flex items-center">
                    {typedText}
                    <span
                      className={`ml-1 w-1 h-10 sm:h-12 md:h-16 lg:h-20 bg-namespace-purple transition-all duration-700 ease-in-out ${
                ...
                <p className="text-lg sm:text-xl md:text-2xl lg:text-2xl text-muted-foreground max-w-2xl font-inter">
